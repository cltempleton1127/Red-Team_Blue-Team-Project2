...
POST logs showing this can be seen [here](https://github.com/cltempleton1127/Red-Team_Blue-Team-Project2/blob/master/Supplemental%20Resources/POST1.png).  One of these log details is broken out [here]() and [here]() as well.
